...
> 发布时间：2026-02-08 23:45  
> - 发布页：<https://github.com/msm9527/msm-wiki/releases/tag/beta-0.9.7>  
> - 下载方式：同一发布页内提供各平台二进制与安装包

### 🔧 变更（Changed）
- 增强机器码兜底并持久化以避免容器激活失败

::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`7e8950b`](https://github.com/msm9527/msm/commit/7e8950b2acb969fc4601c7dbda0edfd72afae9ac)
- **提交信息**: 增强机器码兜底并持久化避免容器激活失败
- **提交作者**: msm
- **提交时间**: 2026-02-08 23:45:55 +0800
:::
