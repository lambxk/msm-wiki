...
> 当前 Beta 版本：`beta-0.9.5`  
> 发布时间：2026-02-08 21:02  
> - 发布页：<https://github.com/msm9527/msm-wiki/releases/tag/beta-0.9.5>  
...
- 强化 Linux nft 下发稳定性
- 增加跨进程锁
- 修复 Linux nftables 重复应用时 Flush file exists

::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`9f63163`](https://github.com/msm9527/msm/commit/9f6316346f05a85699abd3ffbeb6b3949c5b0d9e)
- **提交信息**: fix: 修复 Docker 跨设备更新安装失败
- **提交作者**: msm
- **提交时间**: 2026-02-08 21:02:05 +0800
:::
