...
::: details 📋 构建信息
- **发布通道**: beta（Beta 版）
- **源提交**: [`6bc16fd`](https://github.com/msm9527/msm/commit/6bc16fd5844dd2d71bdb00cb53042f5bf27788b7)
- **提交信息**: 修复授权机器码参数校验并优先随机持久化
- **提交作者**: msm
- **提交时间**: 2026-02-09 00:14:11 +0800
:::
